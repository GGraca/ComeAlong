...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MyUser'
        db.create_table(u'my_user_myuser', (
            ...
            ('avatar', self.gf('django.db.models.fields.files.ImageField')(default='img/default/user.jpg', max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'my_user', ['MyUser'])

        # Adding M2M table for field groups on 'MyUser'
        m2m_table_name = db.shorten_name(u'my_user_myuser_groups')
        ...
        m2m_table_name = db.shorten_name(u'my_user_myuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('myuser', models.ForeignKey(orm[u'my_user.myuser'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'my_user_myuser')

        # Removing M2M table for field groups on 'MyUser'
        db.delete_table(db.shorten_name(u'my_user_myuser_groups'))

        # Removing M2M table for field user_permissions on 'MyUser'
        db.delete_table(db.shorten_name(u'my_user_myuser_user_permissions'))
