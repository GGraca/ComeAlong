...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Event'
        db.create_table(u'project_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'project', ['Event'])

        # Adding field 'Project.event'
        db.add_column(u'project_project', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='projects', null=True, to=orm['project.Event']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Event'
        db.delete_table(u'project_event')

        # Deleting field 'Project.event'
        db.delete_column(u'project_project', 'event_id')
